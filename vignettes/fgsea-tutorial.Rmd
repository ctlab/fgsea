...
independent pathways one can use `selectIndependentPathways` function:

```{r, fig.width=7, fig.height=8, fig.retina=2}
independentPathways <- selectIndependentPathways(fgseaRes[order(pval)][padj < 0.01], 
                                                 examplePathways, exampleRanks)
independentPathways <- fgseaRes[pathway %in% independentPathways][order(-NES), pathway]
plotGseaTable(examplePathways[independentPathways], exampleRanks, fgseaRes, 
              gseaParam = 0.5)
```
