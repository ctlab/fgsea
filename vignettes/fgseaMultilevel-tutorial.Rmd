...
The output table is similar in structure to the table obtained using the `fgsea` function, except for the `logErr` column. This column corresponds to the standard deviation of the P-value logarithm.
