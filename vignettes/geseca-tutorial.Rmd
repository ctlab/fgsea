...
more associated with non-foamy intimal macrophages, which was one of the
main points of the Kim et al.
...
ps <- plotCoregulationProfileSpatial(pathways[topPathways], brain,
                                       title=titles)
cowplot::plot_grid(plotlist=ps[1:4], ncol=2)
```
