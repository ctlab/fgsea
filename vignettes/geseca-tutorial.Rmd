...
Geometrically, this can be imagined as an embedding of samples into 
...
![toy example](geseca-vignette-score-toy-example.png){width=90%}

Another major feature of proposed score is that it does not require 
an explicit sample annotation or a contrast.
As a result, GESECA can be applied to various types of sequencing technologies:
RNA-Seq, single-cell sequencing, spatial RNA-seq, etc.
